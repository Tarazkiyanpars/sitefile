<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMPage.master" AutoEventWireup="true" CodeFile="SelAnbarPage.aspx.cs" Inherits="AdminPages_SelAnbarPage" %>
    ...
    <tr>
        <td>
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                ...
                ForeColor="#333333" GridLines="None" Height="50px" Width="347px" 
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    <asp:CommandField ShowSelectButton="True" ButtonType="Button" 
                        CancelText="انصراف" SelectText="انتخاب" />
                    <asp:BoundField DataField="Code" HeaderText="کد کالا" InsertVisible="False" 
                        ReadOnly="True" SortExpression="Code" />
                    <asp:BoundField DataField="Anbar" HeaderText="کد انبار" 
                        SortExpression="Anbar" />
